                            ...
                            @foreach ($pessoa as $item)
                                <tr class="table-primary">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" wire:click="edit({{ $item->id }})" data-bs-toggle="modal"
                                            data-bs-target="#modalId"><i class="fa fa-eye"></i>
                                            Ver</a>

                                        <a class="btn btn-success" wire:click="edit({{ $item->id }})" data-bs-toggle="modal"
                                            data-bs-target="#modalId"><i class="fa fa-edit"></i>
                                            Editar</a>
